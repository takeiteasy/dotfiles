...
plugins=(alias-finder asdf autojump command-not-found colored-man-pages extract zsh-interactive-cd zsh-navigation-tools bgnotify copybuffer extract jump thefuck vi-mode history-substring-search)
